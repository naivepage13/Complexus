...
import com.geohistoricalsim.jogador.RepositorioJogador;
...
import com.geohistoricalsim.politica.VagasCargo;
...
public class SeedDados implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        log.info("Inicializando o mundo do GeoHistoricalSim...");
